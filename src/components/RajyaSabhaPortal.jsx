...
const RajyaSabhaPortal = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/voters/authenticate`, payload, {
                headers: {
    ...
    return (
        <div>
            <div className="container">
                ...
                <section className="section" id="Rajya-sabha-representatives">
                    <div className="section-header">
...
export default RajyaSabhaPortal;
